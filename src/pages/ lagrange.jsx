            ...
            <div>
                    <Col className="gutter-row" xs={12} sm={12} md={12} lg={12} xl={12}>
                        ...
                        <Form onFinish={onCalculate} initialValues={{remember: true}}>
                             ...
                             rules={[
                                {
                                  ...
                                  message: 'This field is required!',
                                    ...
                                    <Input type="number" onChange={changeDecimal} placeholder="Number of Decimal Places (max of 5)" />
                            </Form.Item>
                            <Form.Item name="valx"
                                 rules={[
                                    {
                            ...
                            >
                                    <Input type="number" onChange={changeValX}  placeholder="Value of x given" />
                            </Form.Item>
                            <Form.Item>
